...
function Default() {
  return (
    <div>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 p-5 lg:px-28 mt-5">
        <div className="w-full bg-slate-50 hover:bg-slate-100 hover:shadow-lg hover:shadow-black/[0.05] border border-slate-200 rounded-xl p-5 font-poppins transition-all">
